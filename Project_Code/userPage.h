...
#pragma region Windows Form Designer generated code
		  ...
		  void InitializeComponent(void)
		  {
			   ...
			   this->btnHideWorkout->Size = System::Drawing::Size(149, 39);
			   ...
			   this->txtWeight->Font = (gcnew System::Drawing::Font(L"Microsoft Sans Serif", 10.8F, System::Drawing::FontStyle::Regular, System::Drawing::GraphicsUnit::Point,
					static_cast<System::Byte>(0)));
			   this->txtWeight->Location = System::Drawing::Point(119, 158);
			   ...
			   this->btnTrackProgress->Size = System::Drawing::Size(171, 34);
			   ...
			   this->comboBox1->Location = System::Drawing::Point(11, 33);
...
#pragma endregion
	 ...
	 private: System::Void button4_Click(System::Object^ sender, System::EventArgs^ e) {
		  ...
		  Subscriptions sub;
		  if (!userList[loginID].subscription.isActive()) {
			   Subscriptions tmpSub(subType, newStartDate, isVIP);
			   sub = tmpSub;
		  }
		  else {
			   Subscriptions tmpSub(subType, userList[loginID].subscription.getEndDate(), isVIP);
			   sub = tmpSub;
		  }
